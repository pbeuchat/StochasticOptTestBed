...
%    else
    ...
    MEASUREData_t=Control_Rand_Local.DefineMeasurements(Param,Cost_vector,current_folder,System,x,xi,predictions,Param.NoActions);
    ...
    save([current_folder,'MEASUREData.mat'],'MEASUREData')
     ...
     actions= Control_Rand_Local.CAO_AUX_CALC(Param, MEASUREData, Update_flag, current_folder,Symbolic_folder,RBC_actions,System,iteration);        %Use of PCAO
...
if Update_flag==1 && System==7
    [ CenterPosition, Global_Cost_buffer ] = Control_Rand_Local.CAO_PERTB_CENTER(Param.NoSystems,day);
    Control_Rand_Local.CAO_TRAIN_EST(CenterPosition, Global_Cost_buffer,day,Param.NoSystems);
end
