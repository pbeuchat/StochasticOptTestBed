classdef Disturbance_Model_001_001 < Disturbance_Model
...
% ----------------------------------------------------------------------- %
    ...
    properties(Hidden,Constant)
        ...
        thisClassName@string = 'Disturbance_Model_001_001';
    end
    ...
    properties (Access = private)
        ...
        stats_directlyAvailable = {'mean','cov'};
    ...
    methods
        ...
        function obj = Disturbance_Model_001_001(inputAnything)
