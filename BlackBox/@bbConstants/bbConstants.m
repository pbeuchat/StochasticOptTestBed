...
%  ---------------------------------------------------------------------  %
    ...
    methods(Static=true , Access=public)
        ...
        % FUNCTION: [...] = checkUniqueness_cellArrayProperty(...)
        [returnFlag_isUnique , return_propertyNames , returnFlag_nameNeedsToBeChanged] = checkUniqueness_cellArrayProperty( inputCellArray , inputPropertyName );
