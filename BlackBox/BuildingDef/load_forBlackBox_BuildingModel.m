...
%  ---------------------------------------------------------------------  %
%  ---------------------------------------------------------------------  %
function [returnB , returnX0 , returnConstraintParams , returnCostParams ] = load_forBlackBox_BuildingModel( inputBuildingIdentifierString , bbFullPath , sysOptions )
...
[returnB , returnX0 , returnConstraintParams, returnCostParams, returnV, returnTmax , returnDims] = thisBuildingDefFunctionHandle( inputBuildingIdentifierString , bbFullPath , sysOptions );
