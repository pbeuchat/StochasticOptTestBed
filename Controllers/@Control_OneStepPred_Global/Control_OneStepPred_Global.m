classdef Control_OneStepPred_Global < Control_GlobalController
...
% ----------------------------------------------------------------------- %
    ...
    properties(Hidden,Constant)
        ...
        thisClassName@string = 'Control_OneStepPred_Gobal';
    ...
    methods
        ...
        function obj = Control_OneStepPred_Global( inputStateDef , inputConstraintDef )
