classdef Control_Constant < Control_LocalController
...
% ----------------------------------------------------------------------- %
    ...
    properties (Access = private)
        ...
        controlActionConstantToApply@double;
    ...
    methods
        ...
        function obj = Control_Constant( input_idnum , inputStateDef , inputConstraintDef , inputGlobalControlObject)
